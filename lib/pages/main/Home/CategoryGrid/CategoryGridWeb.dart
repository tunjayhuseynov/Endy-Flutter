...
class CategoryGridWeb extends StatefulWidget {
  const CategoryGridWeb({Key? key}) : super(key: key);

  @override
  State<CategoryGridWeb> createState() => _CategoryGridWebState();
}

class _CategoryGridWebState extends State<CategoryGridWeb> {
            ...
            return BlocBuilder<CategoryGridBloc, CategoryGridState>(
              builder: (context, state) {
                return Material(
                  ...
                  child: Container(
                    padding:
                        EdgeInsets.symmetric(horizontal: getContainerSize(w)),
                    child: Column(
                      children: [
                        // AnimatedSearchBox(
                        //     focusNode: focusNode,
                        //     editingController: editingController),
                        searchState.search.isNotEmpty
                            ? SearchPage(
                                client: client,
